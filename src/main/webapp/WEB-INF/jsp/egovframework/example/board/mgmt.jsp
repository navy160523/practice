  ...
  <h1>등록/수정화면</h1>
	  ...
	  <div class="panel panel-default">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      <input type="email" class="form-control" id="idx" name="idx" placeholder="자동완성">
		    </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      ...
		      <input type="text" class="form-control" id="indate" name="indate" placeholder="등록일를 입력하세요" maxlength="10" style="float:left;width:40% ">
		    </div>
		  </div>
		  <div class="form-group">
